...
# The code for generating K-shot training and validation files is taken from previous work:
# https://github.com/zjunlp/KnowPrompt/blob/master/generate_k_shot.py
